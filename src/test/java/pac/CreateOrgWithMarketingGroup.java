...
public class CreateOrgWithMarketingGroup {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		FileInputStream fisc=new FileInputStream("./data/commonData.properties");		
	     ...
	     FileInputStream fisexcel=new FileInputStream("./data/TestScriptFor_marketingtest.xlsx");
	    		 Workbook wb=WorkbookFactory.create(fisexcel);
	            Sheet sh=wb.getSheet("sheet1");
	            Row row=sh.getRow(1);
	            Cell cel=row.getCell(2);
	           String orgnaname = cel.getStringCellValue();
	            
	     driver.findElement(By.name("accountname")).sendKeys(orgnaname);
	     ...
	     System.out.println("group as Marketing Group should be selected and new organization should be displayed");
      Thread.sleep(5000);
         
	     String actual = driver.findElement(By.xpath("//span[@class='dvHeaderText']")).getText();
	     System.out.println(actual);
	     if(actual.contains(orgnaname)) {
